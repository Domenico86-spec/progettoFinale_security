...
// Public routes
Route::get('/', [PublicController::class, 'homepage'])->middleware('throttle:10,1')->name('homepage');
...
Route::get('/articles/search', [ArticleController::class, 'articleSearch'])->middleware('throttle:articleSearch')->name('articles.search');
